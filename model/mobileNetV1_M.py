...
相比 V1 版本，增加了 width_multiplier 参数
'''
...
if __name__ == '__main__':
    ...
    model = MyMobileNet_v1_M(width_multiplier=0.25, num_classes=9)
